...
namespace RatingUniversity.Controllers
{
    public class Table13Controller : BaseInputDataController
    {
        ...
        public ActionResult Index(int? id, int? page)
        {
            ...
            return View(this.db.kolichestvo_izdannih_mejdunarodnih_statey.Where(model => model.id_university == id && model.year == this.year).ToList().ToPagedList(pageNumber, pageSize));
        }
