...
{
	public class Jadval18Controller : BaseViewController
    {
        int active;
		...
		public ActionResult Index(int? id, int? page)
		{
			...
			int? status_table = db.Monitorings.Where(x => x.Year == yil).Where(y => y.UniverId == UniverId).Select(z => z.J18).FirstOrDefault();
