...
{
	public class Jadval21Controller : BaseInputDataController
    {
       protected override void Initialize(System.Web.Routing.RequestContext requestContext)
        {
            ...
            this.controllerName = "Jadval21";
            this.tableName = "J21";
            this.procedureName = "P2_3_trudoustroystvo_vipusknikov";
            this.fileName = "table21.xls";
        }
        //
        // GET: /Jadval21/
		...
		public ActionResult Index(int? id, int? page)
		{
			...
			var list = db.Jadval21.Where(pr => pr.Year == this.year).Where(y => y.UniversityId == UniverId).OrderBy(j => j.Year);
...
//			return View(list.ToList());
		...
		private void GetExcelData_Jadval21(DataTable data)
		{
			...
			{
				IQueryable<Jadval21> deleteRows = db.Jadval21.Where(x => x.Year == this.year).Where(y => y.UniversityId == UniverId);
        ...
        {
            TablesContext db = new TablesContext();
            Jadval21 record = db.Jadval21.Find(recordId);
