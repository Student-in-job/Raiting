...
{
	public class Jadval20Controller : BaseInputDataController
    {
        protected override void Initialize(System.Web.Routing.RequestContext requestContext)
        {
            ...
            this.controllerName = "Jadval20";
            this.tableName = "J20";
            this.procedureName = "P2_3_trudoustroystvo_vipusknikov";
            this.fileName = "table20.xls";
        }
        //
        // GET: /Jadval20/
		...
		public ActionResult Index(int? id, int? page)
		{
			...
			var list = db.Jadval20.Where(pr => pr.Year == this.year).Where(y => y.UniversityId == UniverId).OrderBy(j => j.Year);
...
//			return View(list.ToList());
		...
		private void GetExcelData_Jadval20(DataTable data)
		{
			...
			{
				IQueryable<Jadval20> deleteRows = db.Jadval20.Where(x => x.Year == this.year).Where(y => y.UniversityId == UniverId);
        ...
        {
            TablesContext db = new TablesContext();
            Jadval20 record = db.Jadval20.Find(recordId);
