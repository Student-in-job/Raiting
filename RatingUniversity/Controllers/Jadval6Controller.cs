...
{
	public class Jadval6Controller : BaseInputDataController
    {
        protected override void Initialize(System.Web.Routing.RequestContext requestContext)
        {
            ...
            this.controllerName = "Jadval6";
            this.tableName = "J6";
            this.procedureName = "P1_4_dolya_inostrancev";
            this.fileName = "table6.xls";
        }
        //
        // GET: /Jadval6/
		...
		public ActionResult Index(int? id, int? page)
		{
			...
			var list = db.Jadval6.Where(pr => pr.Year == this.year).Where(y => y.UniversityId == UniverId).OrderBy(j => j.Year);
...
//			return View(list.ToList());
		...
		private void GetExcelData_Jadval6(DataTable data)
		{
			int UniverId = this.id;
			...
			{
				IQueryable<Jadval6> deleteRows = db.Jadval6.Where(x => x.Year == this.year).Where(y => y.UniversityId == UniverId);
        ...
        {
            TablesContext db = new TablesContext();
            Jadval6 record = db.Jadval6.Find(recordId);
